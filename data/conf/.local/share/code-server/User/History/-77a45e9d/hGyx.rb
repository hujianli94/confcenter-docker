Gitee::Application.configure do
    ...
    config.cache_store = :redis_store, { cluster: %w[redis://redis-cluster-0.redis-cluster-headless.pub-comm redis://redis-cluster-1.redis-cluster-headless.pub-comm redis://redis-cluster-2.redis-cluster-headless.pub-comm redis://172.18.0.14:7002 redis://172.18.0.17:7002 redis://172.18.0.15:7002], expires_in: 1.day }
