Gitee::Application.configure do
    ...
    config.cache_store = :redis_store, { cluster: %w[redis://redis-cluster-0.redis-cluster-headless.pub-comm redis://redis-cluster-1.redis-cluster-headless.pub-comm redis://redis-cluster-2.redis-cluster-headless.pub-comm redis://redis-cluster-3.redis-cluster-headless.pub-comm redis://redis-cluster-4.redis-cluster-headless.pub-comm redis://redis-cluster-5.redis-cluster-headless.pub-comm], expires_in: 1.day }
    #config.redis = Redis.new(:url => 'redis://192.168.3.7:6379', :driver => :hiredis)
    config.redis = Redis.new(cluster: %w[redis://172.18.0.15:7001 redis://172.18.0.14:7001 redis://172.18.0.17:7001 redis://172.18.0.14:7002 redis://172.18.0.17:7002 redis://172.18.0.15:7002], driver: :hiredis)
    # 内容审查服务专用
    ...
    # TODO
    config.redis_cratos = Redis.new(:url => 'redis://172.18.0.15:6379', :driver => :hiredis)
